...
<body>
<nav class="nav">
  <a href="/" class="nav-logo" aria-label="ApplyCraft home"><img src="/assets/brand/applycraft-logo-light.png" alt="ApplyCraft" class="brand-logo-img" loading="eager" decoding="async"></a>
  ...
  <div class="footer-shell">
    <div class="footer-top">
      <div class="footer-brand">
        <a href="/" class="footer-logo" aria-label="ApplyCraft home"><img src="/assets/brand/applycraft-logo-light.png" alt="ApplyCraft" class="brand-logo-img" loading="lazy" decoding="async"></a>
