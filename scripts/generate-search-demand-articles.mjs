...
const articles = [
  ...
  },
  {
    ...
    title: "Teacher Resume Skills: Examples and Achievements",
    description: "Choose teacher resume skills, see how to present them with evidence, and adapt achievement examples for your experience and teaching context.",
    category: "Education", lead: "The best teacher resume skills combine instructional expertise, classroom leadership and clear evidence of how you support learning. Choose skills that match the vacancy, then demonstrate the most important ones in your summary and experience—not only in a list.",
    readMinutes: 20,
    directAnswer: "Prioritize lesson planning, classroom management, differentiated instruction, student assessment, curriculum knowledge, communication, inclusion and educational technology. Select the skills that are true for you and relevant to the vacancy, then prove them with classroom context, the method you used and an observable result.",
    primary: "/examples/teacher-resume/", cta: "Use the free teacher resume example",
    sections: [
      ["Hard skills and soft skills for teachers", "Hard skills are teachable methods, systems and subject capabilities that can be demonstrated directly. Soft skills describe how you work with learners, families and colleagues. Some abilities cross the boundary: classroom management combines trained techniques with communication, judgment and adaptability.", ["Hard skills: curriculum planning, assessment design, differentiated instruction, learning management systems, student data analysis, learner-support documentation, language instruction and subject expertise", "Soft skills: communication, adaptability, empathy, collaboration, organization, conflict resolution and leadership", "Show technical skills with the method or tool used; show soft skills through a situation, action and observable effect"]],
      ["How to list teaching skills in three resume sections", "Use a compact Skills section for scanability, a professional summary for your strongest fit, and experience bullets for proof. Repeating the same unsupported list in all three places wastes space.", ["Skills: Differentiated instruction · Formative assessment · Google Classroom · Family engagement", "Summary: Secondary mathematics teacher experienced in standards-aligned planning, formative assessment and targeted reteaching for mixed-ability classes", "Experience: Reviewed weekly assessment evidence to form targeted support groups and adjust follow-up lessons"]],
      ["Turn responsibilities into teacher achievements", "Use Action + teaching context + method + observable result. A result can be improved completion, participation or attendance; fewer repeated incidents; faster feedback; successful curriculum adoption; or stronger family engagement. Use only evidence you can explain and defend.", ["Responsibility: Managed classroom behaviour", "Evidence-based: Introduced consistent classroom routines and restorative behaviour practices, reducing repeated disruptions and protecting lesson time", "Responsibility: Graded student work", "Evidence-based: Introduced a shared rubric and scheduled feedback cycle, shortening grading turnaround while giving students clearer next steps"]],
      ["Teacher resume summary template", "[Licensed/certified] [subject or grade] teacher with [years or practicum experience] supporting [learner group]. Experienced in [two vacancy-relevant skills], demonstrated through [truthful result or contribution]. Ready to contribute [specific value] in [school or programme context]."],
      ["Tailor teaching skills to the job description", "Separate required credentials and capabilities from preferences. Reuse the employer's terminology only where it accurately describes your experience, and support priority terms in an experience bullet. Do not add a skill you do not possess or repeat keywords unnaturally."],
      ["Final teacher resume skills checklist", "Before applying, confirm that the page is focused, truthful and easy to scan.", ["Match the grade level, subject, curriculum and required certification", "Keep the Skills section selective rather than exhaustive", "Prove the most important skills in experience or practicum bullets", "Add context such as learner group, teaching method, tool or programme", "Use outcomes you can verify without exposing student information", "Check consistent dates, terminology and verb tense", "Use standard headings and a readable layout", "Remove unsupported adjectives and repeated keywords"]]
    ],
    ...
    faqs: [["What are the best skills to put on a teacher resume?", "Choose instructional, classroom-management, assessment, inclusion, communication and technology skills that match the vacancy, then support the priorities with evidence."], ["How many skills should a teacher resume include?", "A focused selection is more useful than a generic keyword list. Include only skills relevant to the vacancy that you can demonstrate."], ["Should teachers include student results?", "Use aggregate, non-identifying outcomes when they are accurate and explain your contribution. Observable results can also be qualitative when no defensible number exists."], ["What should a first-year teacher put on a resume?", "Include student teaching, practicums, tutoring, locally relevant credentials, grade levels, curriculum projects, educational technology and resources you created."], ["Should I list every classroom tool?", "No. List tools you have actually used and prioritize those requested by the school."]]
  },
  {
