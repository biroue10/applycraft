...
const overlays = {
  ...
  "/blog/how-to-list-online-courses-and-certificates-on-a-resume/": ["how to list online courses and certificates on a resume", "Learn how to classify and present courses, certificates, licences, and course projects honestly", "/resume-builder/"],
...
const priorityDetails = {
  "/blog/how-to-list-online-courses-and-certificates-on-a-resume/": { routeId:"online-courses-certificates-resume", secondaryQueries:["online courses on resume","certificates on resume","how to add certifications to resume","resume certificate examples"], parentCluster:"professional-development", preferredInternalAnchors:["list online courses on a resume","resume certificate examples"], relatedPages:["/resume-builder/","/blog/student-resume-no-experience/"], competingPages:[], differentiation:"Classification and placement of online learning and credentials; student, career-change, and role-specific guides keep their own life-stage or role intents", primaryCta:"/resume-builder/" },
