...
export const TEMPLATES = [
  { id: "blank",     name: "Blank",     tag: "No styling — plain text output",        accent: "#374151", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", blank: true },
  { id: "classic",   name: "Classic",   tag: "Timeless, serif, single column",       accent: "#1f2937", font: "'Georgia', 'Times New Roman', serif", markets: "cifm" },
  { id: "modern",    name: "Modern",    tag: "Clean sans-serif with sidebar",         accent: "#2563eb", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "mfg" },
  { id: "minimal",   name: "Minimal",   tag: "Lots of whitespace, understated",       accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "cimf" },
  { id: "bold",      name: "Bold",      tag: "Strong header band, high contrast",     accent: "#b91c1c", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "fmg" },
  ...
  { id: "executive", name: "Executive", tag: "Split header, left-bar sections, gold", accent: "#d97706", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "mgf" },
  { id: "creative",  name: "Creative",  tag: "Right colour panel, bold & expressive", accent: "#db2777", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "fmg" },
  { id: "tech",      name: "Tech",      tag: "Dark terminal style, monospace, green", accent: "#10b981", font: "'Courier New', 'Courier', monospace", markets: "ci" },
  { id: "sharp",    name: "Sharp",    tag: "Black & white corporate, no colour",   accent: "#111827", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "cif" },
  { id: "slate",    name: "Slate",    tag: "Dark navy sidebar, warm gold accent",  accent: "#d97706", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "mgf" },
  { id: "prism",    name: "Prism",    tag: "Diagonal gradient header, vibrant",    accent: "#7c3aed", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "fmg" },
  { id: "compact",  name: "Compact",  tag: "Two-column body, high density layout", accent: "#0369a1", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "cim" },
  { id: "horizon",  name: "Horizon",  tag: "Centered banner header, strong impact",  accent: "#e14d43", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "fmg" },
  { id: "nordic",   name: "Nordic",   tag: "Scandinavian minimal, wide margins",     accent: "#2d5a27", font: "'Georgia', 'Times New Roman', serif", markets: "cif" },
  { id: "dusk",     name: "Dusk",     tag: "Dark charcoal paper, amber accents",     accent: "#f59e0b", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "ig" },
  { id: "vertex",   name: "Vertex",   tag: "Reversed layout, right sidebar, cyan",   accent: "#06b6d4", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "mg" },
  { id: "academy",  name: "Academy",  tag: "Academic CV, double rule, serif",        accent: "#1e40af", font: "'Georgia', 'Times New Roman', serif", markets: "cif" },
  { id: "spark",    name: "Spark",    tag: "Vibrant section bands, energetic",       accent: "#f97316", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "fmg" },
  ...
  { id: "carbon",   name: "Carbon",   tag: "Charcoal sidebar, square monogram",      accent: "#6b7280", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "mgf" },
  { id: "pulse",    name: "Pulse",    tag: "Gradient left bar, modern startup",      accent: "#8b5cf6", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", markets: "icm" },
  { id: "atlas",    name: "Atlas",    tag: "Executive sidebar with precise spacing", accent: "#1d4ed8", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "executive", markets: "mgf" },
  { id: "nova",     name: "Nova",     tag: "Clean startup layout with bright accents", accent: "#2563eb", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "pulse", markets: "cim" },
  { id: "ember",    name: "Ember",    tag: "Warm high-impact header for concise resumes", accent: "#dc2626", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "bold", markets: "fmg" },
  { id: "linear",   name: "Linear",   tag: "Precise one-column layout with crisp rules", accent: "#334155", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal", markets: "cif" },
  { id: "folio",    name: "Folio",    tag: "Portfolio-forward layout for creative roles", accent: "#7c3aed", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "creative", markets: "fm" },
  { id: "signal",   name: "Signal",   tag: "Technical two-column layout with clear signals", accent: "#0284c7", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "compact", markets: "ci" },
  { id: "orbit",    name: "Orbit",    tag: "Rounded modern structure with strong header", accent: "#4f46e5", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "horizon", markets: "fmg" },
  { id: "mariner",  name: "Mariner",  tag: "Deep blue professional sidebar layout", accent: "#1e40af", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "slate", markets: "mgf" },
  { id: "summit",   name: "Summit",   tag: "Senior leadership layout with refined hierarchy", accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "executive", markets: "mgf" },
  ...
  { id: "craft",    name: "Craft",    tag: "Balanced designer resume with structured sidebar", accent: "#9333ea", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "elegant", markets: "fm" },
  ...
  { id: "aurora",   name: "Aurora",   tag: "Vibrant gradient header for modern teams", accent: "#7c3aed", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "prism", markets: "fmg" },
  ...
  { id: "blueprint", name: "Blueprint", tag: "Structured right-sidebar layout for builders", accent: "#0891b2", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "vertex", markets: "mg" },
  { id: "delta",    name: "Delta",    tag: "Sharp corporate layout with minimal color", accent: "#111827", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "sharp", markets: "cif" },
  ...
  { id: "metro",    name: "Metro",    tag: "Compact city-style layout for fast scanning", accent: "#0369a1", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "compact", markets: "cim" },
  { id: "verve",    name: "Verve",    tag: "Energetic bands for sales and marketing", accent: "#f97316", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "spark", markets: "fmg" },
  { id: "consultant", name: "Consultant", tag: "Polished one-column format for client work", accent: "#1f2937", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal", markets: "cif" },
  { id: "founder",  name: "Founder",  tag: "Bold leadership resume for operators", accent: "#4338ca", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "bold", markets: "fmg" },
  { id: "graduate", name: "Graduate", tag: "Clean academic-friendly layout for early careers", accent: "#2563eb", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "academy", markets: "cifm" },
  { id: "clinical", name: "Clinical", tag: "Clear healthcare layout with standard headings", accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "classic", markets: "cif" },
  { id: "toronto", name: "Toronto", tag: "Canadian ATS single-column, achievement-first", accent: "#1d4ed8", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal", markets: "ci", filters: ["ats", "one", "modern", "recommended"],
    gallery: {
  ...
  { id: "vancouver", name: "Vancouver", tag: "Canadian modern skills sidebar, ATS-readable DOM order", accent: "#0284c7", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "compact", markets: "ci", filters: ["ats", "two", "modern"],
    gallery: {
  ...
  { id: "global", name: "Global", tag: "Ultra-clean international ATS layout with zero decoration", accent: "#111827", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal", markets: "ci", filters: ["ats", "one", "traditional"],
    gallery: {
  ...
  { id: "meridian", name: "Meridian", tag: "International single-column with thin rule separators", accent: "#475569", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "sharp", markets: "ci", filters: ["ats", "one", "traditional"],
    gallery: {
  ...
  { id: "atlas-pro", name: "Atlas Pro", tag: "Decluttered executive layout for ATS-first international resumes", accent: "#1d4ed8", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "executive", markets: "ci", filters: ["ats", "two", "traditional"],
    gallery: {
  ...
  { id: "passport", name: "Passport", tag: "Compact international one-page format", accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "compact", markets: "ci", filters: ["ats", "compact", "two"],
    gallery: {
  ...
  { id: "casablanca", name: "Casablanca", tag: "Modern Morocco-ready layout with optional photo and FR/AR support", accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "modern", markets: "mfg", filters: ["two", "modern", "rtl"],
    gallery: {
  ...
  { id: "medina", name: "Médina", tag: "Bilingual FR/AR layout with strong RTL support", accent: "#0891b2", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "vertex", markets: "mfg", filters: ["two", "modern", "rtl"],
    gallery: {
  ...
  { id: "dubai", name: "Dubaï", tag: "Contemporary Gulf corporate layout with optional photo", accent: "#d97706", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "slate", markets: "mg", filters: ["two", "modern", "rtl"],
    gallery: {
  ...
  { id: "khaleej", name: "Khaleej", tag: "Modern bilingual Gulf layout for Arabic and English", accent: "#06b6d4", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "vertex", markets: "mg", filters: ["two", "modern", "rtl"],
    gallery: {
...
export const COVER_TEMPLATES = [
  { id: "blank",   name: "Blank",   tag: "Plain text, no styling",            accent: "#374151", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", blank: true },
  { id: "classic", name: "Classic", tag: "Traditional block letter, serif",   accent: "#1f2937", font: "'Georgia', 'Times New Roman', serif" },
  { id: "modern",  name: "Modern",  tag: "Left sidebar with your details",    accent: "#2563eb", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif" },
  { id: "minimal", name: "Minimal", tag: "Clean, precise, lots of whitespace",accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif" },
  { id: "bold",    name: "Bold",    tag: "Full-bleed accent header",           accent: "#b91c1c", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif" },
  { id: "elegant", name: "Elegant", tag: "Soft sidebar, refined serif type",  accent: "#7c3aed", font: "'Georgia', 'Palatino Linotype', serif" },
  { id: "atlas",   name: "Atlas",   tag: "Polished blue sidebar for executive letters", accent: "#1d4ed8", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "modern" },
  { id: "nova",    name: "Nova",    tag: "Bright modern letter with clean hierarchy", accent: "#2563eb", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal" },
  { id: "ember",   name: "Ember",   tag: "Confident header style for concise pitches", accent: "#dc2626", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "bold" },
  { id: "slate",   name: "Slate",   tag: "Dark professional sidebar with restrained detail", accent: "#334155", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "modern" },
  ...
  { id: "linear",  name: "Linear",  tag: "Minimal one-column letter with precise spacing", accent: "#334155", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal" },
  { id: "summit",  name: "Summit",  tag: "Executive cover letter with calm blue accents", accent: "#1e40af", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "classic" },
  ...
  { id: "metro",   name: "Metro",   tag: "Compact modern letter for fast scanning", accent: "#0369a1", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "modern" },
  ...
  { id: "pulse",   name: "Pulse",   tag: "Startup-ready letter with strong accent treatment", accent: "#8b5cf6", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "bold" },
  { id: "clinical", name: "Clinical", tag: "Clear healthcare-friendly letter format", accent: "#0f766e", font: "'IBM Plex Sans', 'IBM Plex Sans Arabic', system-ui, sans-serif", variant: "minimal" },
];
