const builder = {
  ...
  "translateContentConfirm": "Cette action remplacera le contenu rédigé de votre CV par une traduction en {language}. Vos coordonnées et la mise en page resteront inchangées. Continuer ?",
  "translateContentHint": "Utilisez cette action uniquement si vous voulez traduire tout le texte du CV, pas seulement les libellés.",
