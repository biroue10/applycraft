const status = {
  ...
  "shareCreate": "Créer un lien court",
  "shareCreateOffline": "Créer un lien privé hors ligne",
  "shareCreating": "Création du lien...",
  "shareEmail": "Envoyer le lien court",
  "shareCopyPrivate": "Copier le lien",
  "shareOpen": "Ouvrir",
  "shareReady": "Lien de partage court prêt.",
  "shareOfflineReady": "Lien de partage privé hors ligne prêt.",
  "shareCanView": "Toute personne disposant du lien complet peut consulter ce document.",
  "shareStored": "Une copie est stockée pendant 30 jours afin de conserver un lien court.",
  "shareOfflineStored": "Le document reste dans l'URL ; ce lien privé hors ligne peut donc être long.",
  "shareFailed": "Impossible de créer le lien court. Réessayez ou utilisez le lien privé hors ligne.",
