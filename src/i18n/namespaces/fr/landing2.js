const landing2 = {
  "mp": {
    "eyebrow": "Profil principal",
    "t1": "Créez une fois.",
    "t2": "Adaptez pour tout.",
    ...
    "btn": "Créer mon profil principal →",
    "s1": "Remplissez tout votre parcours une seule fois",
    "s2": "Collez n'importe quelle description de poste",
    "s3": "L'IA évalue et sélectionne les éléments pertinents",
    "s4": "CV adapté en un clic, prêt à envoyer"
  },
  "hiw": {
  ...
  "strip": {
    ...
    "noMatch": "Aucun modèle ne correspond à",
    "clearSearch": "Effacer la recherche",
    "browseAllPre": "Parcourir les",
    "browseAllSuf": "modèles →",
    "templatesWord": "modèles",
    "showingPre": "Affichage de 6 sur",
    "foundSuf": "trouvés"
  },
  "pledge": {
  ...
  "cmp": {
    ...
    "rows": [
      [
        "Téléchargement PDF et DOCX gratuit",
        "Payant"
      ],
      [
        "Aucun compte requis",
      ...
      [
        "Aucune carte au téléchargement",
        "Carte requise"
      ],
      [
        "Sans filigrane",
      ...
      [
        "CV et lettres illimités",
        "1 gratuit, puis payant"
      ],
      [
        "Vérificateur ATS intégré",
        "Premium uniquement"
      ],
      [
  ...
  "ml": {
    ...
    "cards": [
      ...
      },
      {
        ...
        "d": "Créez une lettre assortie avec la même approche de mise en forme que votre CV."
      }
    ]
  },
  "priv": {
    "eyebrow": "Confidentialité et confiance",
    "title": "Vos données de CV restent les vôtres. Toujours.",
    ...
    "cards": [
      {
        "t": "Aucun compte requis",
        "b": "ApplyCraft n'exige ni e-mail, ni mot de passe, ni profil de compte pour utiliser l'éditeur principal."
      },
      {
      ...
      },
      {
        ...
        "b": "L'éditeur est conçu pour réduire la quantité de données personnelles traitées par le service."
      },
      {
        "t": "Supprimer les données locales",
        "b": "Supprimez de ce navigateur le profil principal, le suivi des candidatures et les enregistrements du vérificateur ATS créés par ApplyCraft."
      },
      {
        "t": "Export côté navigateur",
        "b": "L'export standard PDF et DOCX s'exécute dans le navigateur en JavaScript."
      },
      {
        "t": "Aucun profil de compte",
        "b": "Aucun e-mail, mot de passe ou tableau de bord n'est requis avant de créer et télécharger un CV."
      }
    ],
    "del": "Supprimer les données locales",
    "read": "Lire notre politique de confidentialité →"
  },
  "ea": {
    ...
    "p2": "Pas de faux avis. Pas de discours marketing. Si ApplyCraft vous aide à décrocher un entretien, nous serions ravis de le savoir — votre avis oriente les prochaines fonctionnalités.",
  ...
  "faq": {
    ...
    "items": [
      {
        "q": "ApplyCraft est-il vraiment gratuit ?",
        "a": "Oui. L'éditeur, les modèles, les options de langue, les aperçus et les téléchargements PDF ou DOCX sont disponibles sans offre payante, compte ni carte bancaire."
      },
      {
      ...
      },
      {
        ...
        "a": "PDF et DOCX. Le PDF convient à la plupart des candidatures. Le DOCX est disponible pour les recruteurs qui ont besoin d'un fichier modifiable."
      },
      {
        "q": "Dois-je créer un compte ?",
        "a": "Non. Aucune inscription, aucune connexion, aucune adresse e-mail requise. Ouvrez l'application et commencez immédiatement."
      }
    ]
  },
  "final": {
  ...
  "demo": {
    ...
    "title": "Créez votre première ébauche de CV en 30 secondes",
    "desc": "Ajoutez trois informations et voyez votre CV prendre forme instantanément. Améliorez votre réussite, personnalisez le design et continuez lorsque vous êtes prêt.",
    "edit": "Modifier",
    "preview": "Aperçu",
    "continueResume": "Continuer avec ce CV",
    "continueBuilder": "Continuer vers l’éditeur complet",
    "noSignupSaveExport": "Aucune inscription requise pour commencer. Téléchargez votre PDF ou DOCX avant de fermer la page.",
    "fullBuilderExportAvailable": "L’export PDF et DOCX est disponible dans l’éditeur complet.",
    "expandedPreview": "Aperçu du CV agrandi",
    "guidedDraft": "Ébauche de CV guidée",
    ...
    "fullNameHelp": "Utilisé dans l’en-tête du CV.",
    "jobTitle": "Intitulé du poste",
    "jobTitleHelp": "Adaptez-le au poste visé.",
    "oneAchievement": "Une réussite professionnelle",
    "achievementHelp": "Ajoutez si possible un résultat, un chiffre ou un impact métier.",
    "demoSuggestion": "Suggestion de démo",
    "improving": "Amélioration…",
    "improveWithAi": "Améliorer avec l’IA",
    "suggestedRewrite": "Reformulation suggérée",
    "accept": "Accepter",
    "undo": "Annuler",
    "deterministicNote": "Il s’agit d’une suggestion de démo déterministe. La démo publique n’appelle pas de service IA payant.",
    "trySampleProfile": "Essayer un profil d’exemple",
    "resetDemo": "Réinitialiser la démo",
    "resumeTemplate": "Modèle de CV",
    "selected": "Sélectionné",
    "atsFriendly": "Compatible ATS",
    "atsEstimateTitle": "Compatibilité ATS estimée",
    "atsSuggestionName": "Ajoutez un nom complet pour que les recruteurs puissent identifier le CV.",
    "atsSuggestionTitle": "Ajoutez un poste cible pour mieux aligner les mots-clés.",
    "atsSuggestionAchievement": "Ajoutez une réussite avec un impact clair.",
    "atsSuggestionMetric": "Ajoutez un résultat mesurable pour renforcer cette réussite.",
    "atsSuggestionVerb": "Commencez par un verbe d’action plus fort.",
    "atsSuggestionReady": "Votre CV contient les informations clés attendues par les ATS.",
    "atsEstimateDisclaimer": "Estimation uniquement. Elle ne garantit aucun résultat auprès d’un ATS.",
    "featureChips": [
      ["Conseils ATS en direct", "Les vérifications se mettent à jour avec le brouillon."],
      ["CV multilingues", "Prévisualisez les libellés dans les langues prises en charge."],
      ["Coaching IA des réussites", "La démo montre l’impact avant/après."],
      ["Export PDF et DOCX", "L’export reste disponible dans l’éditeur complet."]
    ],
    "accentColor": "Couleur d’accent",
    "useAccent": "Utiliser l’accent {color}",
    "language": "Langue",
    "livePreview": "Aperçu en direct",
    "expand": "Agrandir",
    "livePreviewAria": "Aperçu du CV généré en direct",
    "creatingSuggestion": "Création d’une suggestion de démo déterministe.",
    "suggestionReady": "Suggestion de démo prête.",
    "suggestionAccepted": "Suggestion de démo acceptée.",
    "suggestionUndone": "Suggestion annulée.",
    "sampleLoaded": "Profil d’exemple chargé.",
