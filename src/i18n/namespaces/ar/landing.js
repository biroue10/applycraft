const landing = {
  ...
  "scanner": { "aria": "رسم توضيحي لسيرة ذاتية احترافية يجري تحليلها وتنظيمها في بنية ملائمة لأنظمة ATS", "notes": ["تم اكتشاف الخبرة", "تم تنظيم المهارات", "تم التعرّف على التعليم", "بنية ملائمة لأنظمة ATS", "الملف جاهز"] },
  "mockup": { "initials": "أم", "name": "أمينة المنصوري", "title": "مصممة منتجات", "experience": "الخبرة", "role": "مصممة منتجات أولى", "date": "2022 — الآن", "achievement": "قادت تصميم تجارب رقمية سهلة الوصول وحسّنت نتائج العملاء في الأسواق الدولية.", "skills": "المهارات", "skillItems": ["البحث", "أنظمة التصميم", "الاستراتيجية"], "ats": "متوافق مع ATS" },
