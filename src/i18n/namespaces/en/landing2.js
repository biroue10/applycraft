const landing2 = {
  "mp": {
    ...
    "btn": "Build my Master Profile →",
    "s1": "Fill your complete career history once",
    "s2": "Paste any job description",
    "s3": "AI scores and selects relevant items",
    "s4": "One-click tailored resume, ready to send"
  },
  "hiw": {
  ...
  "strip": {
    ...
    "noMatch": "No templates match",
    "clearSearch": "Clear search",
    "browseAllPre": "Browse all",
    "browseAllSuf": "templates →",
    "templatesWord": "templates",
    "showingPre": "Showing 6 of",
    "foundSuf": "found"
  },
  "pledge": {
  ...
  "ml": {
    ...
    "cards": [
      ...
      },
      {
        ...
        "d": "Create a matching cover letter with the same formatting approach as your resume."
      }
    ]
  },
  "priv": {
    ...
    "cards": [
      {
        ...
        "b": "ApplyCraft does not require an email, password, or account profile to use the core resume builder."
      },
      {
      ...
      },
      {
        ...
        "b": "The builder is designed to reduce the amount of personal data handled by the service."
      },
      {
        "t": "Delete local data",
        "b": "Remove ApplyCraft-created master profile, job tracker, and ATS checker records from this browser."
      },
      {
        "t": "Browser-side export",
        "b": "The standard PDF and DOCX export flow runs in the browser using JavaScript."
      },
      {
        "t": "No account profile",
        "b": "No email, password, or personal dashboard is required before creating and downloading a resume."
      }
    ],
  ...
  "ea": {
    ...
    "p2": "No fake reviews. No VC spin. If you use ApplyCraft and it helps you land an interview, we'd genuinely love to hear about it — your feedback shapes what gets built next.",
  ...
  "demo": {
    ...
    "title": "Build your first resume draft in 30 seconds",
    "desc": "Add three details and watch your resume take shape instantly. Improve your achievement, customize the design, and continue when you are ready.",
    "edit": "Edit",
    "preview": "Preview",
    ...
    "customize": "Customize",
    "fullName": "Full name",
    "fullNameHelp": "Used in the resume header.",
    "jobTitle": "Job title",
    "jobTitleHelp": "Match the role you are applying for.",
    "oneAchievement": "One professional achievement",
    "achievementHelp": "Add a result, number, or business impact when possible.",
    "demoSuggestion": "Demo suggestion",
    "improving": "Improving...",
    "improveWithAi": "Improve with AI",
    "suggestedRewrite": "Suggested rewrite",
    "accept": "Accept",
    "undo": "Undo",
    "deterministicNote": "This is a deterministic demo suggestion. The public demo does not call a paid AI service.",
    "trySampleProfile": "Try a sample profile",
    "resetDemo": "Reset demo",
    "resumeTemplate": "Resume template",
    "selected": "Selected",
    "atsFriendly": "ATS friendly",
    "atsEstimateTitle": "Estimated ATS compatibility",
    "atsSuggestionName": "Add a full name so recruiters can identify the resume.",
    "atsSuggestionTitle": "Add a target job title to improve keyword alignment.",
    "atsSuggestionAchievement": "Add one achievement to show measurable impact.",
    "atsSuggestionMetric": "Add a measurable result to strengthen this achievement.",
    "atsSuggestionVerb": "Start your achievement with a stronger action verb.",
    "atsSuggestionReady": "Your resume includes the key information ATS systems expect.",
    "atsEstimateDisclaimer": "Estimate only. It does not guarantee success with any applicant tracking system.",
    "featureChips": [
      ["Live ATS guidance", "Estimated checks update as the draft improves."],
      ["Multilingual resumes", "Preview section labels in supported languages."],
      ["AI achievement coaching", "Local demo rewrite shows before/after impact."],
      ["PDF and DOCX export", "Export actions continue in the full builder."]
    ],
    ...
    "expand": "Expand",
    "livePreviewAria": "Live generated resume preview",
    "creatingSuggestion": "Creating a deterministic demo suggestion.",
    "suggestionReady": "Demo suggestion ready.",
    "suggestionAccepted": "Demo suggestion accepted.",
    "suggestionUndone": "Suggestion undone.",
    "sampleLoaded": "Sample profile loaded.",
    "demoReset": "Demo reset.",
    "exportReady": "Your {format} draft is ready. Continue to the full builder to customize and export it.",
    "exportAvailable": "{format} export is available in the full builder."
  },
