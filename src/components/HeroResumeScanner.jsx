...
export default function HeroResumeScanner({ copy, rtl = false }) {
  ...
  return <section className="ac-hero-preview ac-resume-scanner" dir={rtl ? "rtl" : "ltr"}>
    <style>{`
      ...
      .ac-scan-notes{position:absolute;inset:0;z-index:5;pointer-events:none}.ac-scan-note{position:absolute;max-width:160px;padding:9px 12px;border:1px solid #a78bfa55;border-radius:10px;background:#11182ddd;box-shadow:0 14px 34px #02061788;backdrop-filter:blur(10px);color:#e9e7ff;font-size:11px;font-weight:750;opacity:0;animation:acNote 6.6s ease infinite}.ac-scan-note-check{margin-inline-end:6px;color:#a78bfa}.ac-scan-note:nth-child(1){top:26%;inset-inline-end:0}.ac-scan-note:nth-child(2){top:49%;inset-inline-start:0;animation-delay:1.15s}.ac-scan-note:nth-child(3){top:71%;inset-inline-end:2%;animation-delay:2.3s}
