export const STARTER_METADATA = [
  ...
  { id: "canadian", slug: "canadian-resume-builder", templateId: "classic", documentLanguage: "en", localizedSlugs: { en: "canadian-resume-builder", example: "canadian-resume-format" }, labels: { en: "Canadian Resume", fr: "CV canadien", ar: "سيرة ذاتية كندية" } },
