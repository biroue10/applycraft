...
function entry(fields) {
  const next = { visible: true, ...fields };
  if (/^(present|présent|الحاضر|حتى الآن)$/i.test(String(next.endDate || "").trim())) {
    next.endDate = "";
    next.isCurrent = true;
  }
  return next;
...
const DATA_BY_ID = {
  "sales-representative": form({
    ...
    experience: [
      { title: "Sales Representative", company: "CloudWorks SaaS", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• Achieved 128% of annual quota ($1.9M) and ranked top 5 of 40 reps two years running.\n• Grew territory pipeline by 60% through targeted outbound campaigns and closed 3 of the team's 5 largest deals.") },
  ...
  "it-support-technician": form({
    ...
    experience: [
      { title: "IT Support Technician", company: "FinanceCo Group", startDate: "Jan 2023", endDate: "", isCurrent: true, description: bullet("• Provide L1/L2 technical support to 280 employees and resolve 98% of tickets within SLA.\n• Built an onboarding checklist that cut new employee setup time from 4 hours to 90 minutes.") },
  ...
  "customer-service": form({
    ...
    experience: [
      { title: "Customer Service Team Lead", company: "TeleServ Inc.", startDate: "Mar 2022", endDate: "", isCurrent: true, description: bullet("• Lead a team of 12 agents supporting 1,200+ customers daily.\n• Improved team CSAT from 88% to 96% in 6 months through coaching and quality reviews.") },
  ...
  "project-manager": form({
    ...
    experience: [
      { title: "Senior Project Manager", company: "Meridian Solutions", startDate: "2020", endDate: "", isCurrent: true, description: bullet("• Delivered a $4.2M ERP rollout across 5 departments on time and 8% under budget.\n• Managed a cross-functional team of 18 and reduced project risk incidents by 40%.") },
  ...
  "data-analyst": form({
    ...
    experience: [
      { title: "Data Analyst", company: "Retail Insights Co.", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• Built a Tableau revenue dashboard adopted by 120+ stakeholders, saving ~15 hours/week.\n• Ran an A/B test that lifted checkout conversion by 11%.") },
  ...
  "teacher": form({
    ...
    experience: [
      { title: "3rd Grade Teacher", company: "Maple Grove Elementary", startDate: "2019", endDate: "", isCurrent: true, description: bullet("• Teach a class of 26 across all core subjects and raised class reading proficiency by 18 percentage points.\n• Led a grade-level team adopting a new math curriculum.") },
  ...
  "software-engineer": form({
    ...
    experience: [
      { title: "Senior Software Engineer", company: "Northwind Cloud", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• Led redesign of a payments service handling $40M/month, cutting p99 latency from 800ms to 180ms.\n• Mentored 4 engineers and reduced PR cycle time by 35%.") },
  ...
  "accountant": form({
    ...
    experience: [
      { title: "Senior Accountant", company: "Lone Star Manufacturing", startDate: "2020", endDate: "", isCurrent: true, description: bullet("• Own month-end close for a $90M business unit, reducing close time from 9 to 5 days.\n• Identified $310K in annual savings through vendor reconciliation.") },
  ...
  "administrative-assistant": form({
    ...
    experience: [
      { title: "Administrative Assistant", company: "Desert Ridge Group", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• Support 3 directors with calendars, travel, and expenses.\n• Built a shared scheduling system that reduced meeting setup time by 30%.") },
  ...
  "registered-nurse": form({
    ...
    experience: [
      { title: "Registered Nurse - Medical/Surgical", company: "Grady Memorial Hospital", startDate: "2020", endDate: "", isCurrent: true, description: bullet("• Provide direct care for up to 6 acute patients per shift on a 32-bed unit.\n• Maintained 98% medication-administration accuracy and precepted 7 new-grad nurses.") },
  ...
  "help-desk-analyst": form({
    ...
    experience: [
      { title: "Help Desk Analyst", company: "InsuranceGroup", startDate: "Jun 2022", endDate: "", isCurrent: true, description: bullet("• Handle 75 tickets/day via phone, email, and chat with 99% SLA compliance.\n• Authored 18 knowledge base articles reducing repeat tickets by 22%.") },
  ...
  "linux-administrator": form({
    ...
    experience: [
      { title: "Linux Administrator", company: "StreamingMedia Corp", startDate: "Feb 2021", endDate: "", isCurrent: true, description: bullet("• Administer 400+ RHEL and Ubuntu servers across AWS and on-premises.\n• Implemented Ansible automation reducing patching time from 3 days to 4 hours and maintained 99.95% uptime.") },
  ...
  "linux-system-administrator": form({
    ...
    experience: [
      { title: "Linux System Administrator", company: "CloudHost Systems", startDate: "2020", endDate: "", isCurrent: true, description: bullet("• Manage 250+ Linux servers and automated patching with Ansible.\n• Improved monitoring coverage and reduced critical incident response time by 35%.") },
  ...
  "canadian": form({
    ...
    experience: [
      { title: "Operations Coordinator", company: "Maple Logistics", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• Coordinated daily logistics across 3 warehouse teams and improved on-time dispatch from 91% to 97%.\n• Built Excel reporting used by managers to identify recurring bottlenecks.") },
  ...
  "french-cv": form({
    ...
    experience: [
      { title: "Responsable Marketing Digital", company: "Payfit", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• Pilotage d'un budget annuel de 2 M€ sur Google, LinkedIn et Meta avec un ROAS moyen de 4,2.\n• Lancement de 4 marchés européens et croissance de l'équipe marketing de 2 à 14 personnes.") },
  ...
  "arabic-resume": form({
    ...
    experience: [
      { title: "مهندس مشروع", company: "شركة أطلس للبناء", startDate: "2021", endDate: "", isCurrent: true, description: bullet("• إدارة تنفيذ مشروع سكني يضم 120 وحدة مع الالتزام بالجدول الزمني ومعايير السلامة.\n• تنسيق عمل 5 مقاولين فرعيين وخفض ملاحظات الجودة بنسبة 30%.") },
  ...
  "uk-cv": form({
    ...
    experience: [
      { title: "Operations Manager", company: "Northern Manufacturing Ltd", startDate: "Sep 2020", endDate: "", isCurrent: true, description: bullet("• Responsible for a £4.2M annual production budget and a team of 38 operatives.\n• Reduced waste by 18% and improved OEE from 72% to 84% through Lean Six Sigma initiatives.") },
