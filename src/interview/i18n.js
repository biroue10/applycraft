...
const INTERVIEW_I18N = {
  en: {
    dir: "ltr",
    heading: "Practice before your interview",
    subheading: "Practice questions for a real role, then review structured feedback to make your next answer clearer.",
    setup: {
  ...
  fr: {
    dir: "ltr",
    heading: "Préparez votre entretien",
    subheading: "Entraînez-vous sur une offre réelle, puis relisez un bilan structuré pour rendre vos réponses plus claires.",
    setup: {
  ...
  ar: {
    dir: "rtl",
    heading: "تدرّب قبل مقابلتك",
    subheading: "تدرّب على أسئلة مرتبطة بوظيفة حقيقية، ثم راجع ملاحظات منظّمة لتجعل إجاباتك أوضح.",
    setup: {
